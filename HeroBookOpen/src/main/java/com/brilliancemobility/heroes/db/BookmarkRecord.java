...
{
	public static Uri CONTENT_URI = Uri.parse("content://com.brilliancemobility.heroes.provider/bookmarks");
    ...
    public static SimpleDAO<BookmarkRecord> getDao(Context context)
    {
    	return new SimpleDAO<BookmarkRecord>(context, TABLE_NAME, COLUMNS, BookmarkRecord.class);
    }
	...
	public static void record(Context context, String name, String title, String type, String url, int pageNumber, int pageSize)
	{
		...
		{
			SimpleDAO<BookmarkRecord> dao = BookmarkRecord.getDao(context.getApplicationContext());
	...
	public static BookmarkRecord get(SimpleDAO<BookmarkRecord> dao, String type, String url)
	{
		BookmarkRecord record = new BookmarkRecord();
		record.setType(type);
		record.setUrl(url);
