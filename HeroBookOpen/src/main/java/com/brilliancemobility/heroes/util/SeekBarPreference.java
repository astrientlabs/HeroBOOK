...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener
{
	...
	private static final String NAMESPACE = "http://hostj2me.com";
	...
	private void setValuesFromXml(AttributeSet attrs)
	{
		...
		mMinValue = attrs.getAttributeIntValue(NAMESPACE, "min", 0);

		mUnitsLeft = getAttributeStringValue(attrs, NAMESPACE, "unitsLeft",
				"");
		String units = getAttributeStringValue(attrs, NAMESPACE, "units", "");
		mUnitsRight = getAttributeStringValue(attrs, NAMESPACE, "unitsRight",
				units);

		try
		{
			String newInterval = attrs.getAttributeValue(NAMESPACE,
					"interval");
			if (newInterval != null)
